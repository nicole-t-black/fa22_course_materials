...
# Create a fit object
# When writing formulas (x ~ y), x is what's being plotted and y (known as a "feature") is what is grouping x into categories
?surv_fit
...
Remember, you can use write.csv() to save a data frame to a .csv file, and you can use read.table() to read a .csv file back into a data frame.
