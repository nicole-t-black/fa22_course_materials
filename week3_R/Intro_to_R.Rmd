...
The syntax for "if", "else if", and "else" statements is as follows. Add conditions and actions so that the "if" statement is skipped, and the "else if" runs, printing out "Success!". Run the block to test.
...
Let's try this out! In the mtcars data frame, there is a column called "am". This column holds transmission information where 0 = automatic, and 1 = manual. But as of now, this isn't very clear.
...
Pull the R_Tutorial.Rmd file (in week3_r) from the course materials repo. That file will take your through 
